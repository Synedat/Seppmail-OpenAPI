...
## Purpose
This document deepens the repository-specific architecture story for **Seppmail-OpenAPI**.

## Core focus
OpenAPI descriptions, validation and client-generation support for SEPPmail endpoints
