...
This repository is intended to support **schema-first thinking, contract review, example generation, linting and API discoverability**. The examples are deliberately conservative and should be adapted to the target environment.
